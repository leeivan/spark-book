...
<p align="center"><img src="../media/05_stream_processing/media/image7.png" alt="火流" /></p>
<p align="center">图例 5‑7 一定时间段的数据流</p>


对离散流应用的任何操作都将转换为底层RDD上的操作，例如将输入流lines通过flatMap()转换为包含单词的离散流words，如下图所示：

<p align="center"><img src="../media/05_stream_processing/media/image8.png" alt="火流" /></p>
...
<p align="center"><img src="../media/05_stream_processing/media/image9.png" alt="火流" /></p>
