...
<p align="center"><img src="../media/05_stream_processing/media/image10.png" alt="" /></p>
<p align="center">图例 5‑10 将新数据从离散流添加到无边界表</p>


每次触发到来时，新数据会被追加到输入表中，增量执行逻辑会更新结果表。随后，引擎再把结果表中新产生或发生变化的部分写入外部接收器。图例 5‑11 展示了这一过程：

<p align="center"><img src="../media/05_stream_processing/media/image11.png" alt="" /></p>
...
<p align="center"><img src="../media/05_stream_processing/media/image12.png" alt="" /></p>
...
<p align="center"><img src="../media/05_stream_processing/media/image13.png" alt="" /></p>
